-- =============================================================================
--  VHDL instance generated by IPExpress    07/14/2022    12:49:40         
--  Filename: test_la0_inst.vhd                                          
...
PACKAGE test_la0_pkg IS
    ...
    PORT (
        ...
        trace_din:	IN std_logic_vector (42 downto 0);
        ip_enable:	IN std_logic
    );

    END COMPONENT;

END PACKAGE test_la0_pkg;
